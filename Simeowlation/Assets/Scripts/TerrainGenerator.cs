...
public class TerrainGenerator : MonoBehaviour
{
  ...
  //   void SpawnTerrain(Vector3 startPosition)
  //   {
  //     GameObject newTerrain = theTerrainPool.GetPooledObj();
  //     newTerrain.transform.position = new Vector3(transform.position.x + (terrainWidth / 2), transform.position.y, transform.position.z);
  //     newTerrain.SetActive(true);
  //   }
}
